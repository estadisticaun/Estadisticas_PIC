...
Agregar(TOTAL ~ YEAR + SEMESTRE,
              ...
              Plot.Series(categoria = "TOTAL",
               ...
               titulo = "Evolución histórica total de aspirantes a pregrado, periodo 2018-2026",
...
Agregar(INS_SEDE_NOMBRE ~ YEAR + SEMESTRE,
           ...
           Plot.Series(categoria = "INS_SEDE_NOMBRE",
              titulo = "Evolución total de aspirantes a pregrado por sedes de inscripción, periodo 2018-2026",
              labelY = "Número de aspirantes<br>",
...
Agregar(SEXO ~ YEAR + SEMESTRE,
           ...
           Plot.Series(categoria = "SEXO",
              titulo = "Evolución % total de aspirantes a pregrado por género, periodo 2018-2026",
...
Agregar(ESTRATO ~ YEAR + SEMESTRE,
           ...
           Plot.Series(categoria = "ESTRATO",
              titulo = "Evolución % total de aspirantes a pregrado por estrato, periodo 2018-2026",
              labelY = "Número de aspirantes",
...
Agregar(MOD_INS ~ YEAR + SEMESTRE,
           ...
           Plot.Series(categoria = "MOD_INS",
              titulo = "Evolución % total de aspirantes a pregrado por modalidad de inscripción, periodo 2018-2026",
              labelY = "Número de aspirantes",
...
Agregar(TIPO_INS ~ YEAR + SEMESTRE,
           ...
           Plot.Series(categoria = "TIPO_INS",
              titulo = "Evolución % total de aspirantes a pregrado por tipología programa de inscripción, periodo 2018-2026",
              labelY = "Número de aspirantes",
...
Agregar(PAES ~ YEAR + SEMESTRE,
           ...
           Plot.Series(categoria = "PAES",
              titulo = "Evolución % total de aspirantes a pregrado programa PAES, periodo 2018-2026",
              labelY = "Número de aspirantes",
...
Agregar(PEAMA ~ YEAR + SEMESTRE,
           ...
           Plot.Series(categoria = "PEAMA",
              titulo = "Evolución % total de aspirantes a pregrado Programa PEAMA, periodo 2018-2026",
              labelY = "Número de aspirantes",
...
Agregar(TOTAL ~ YEAR + SEMESTRE,
              ...
              Plot.Series(categoria = "TOTAL",
               colores = c("#8cc63f"), # verde, Total
               titulo = "Evolución histórica total de admitidos a pregrado, periodo 2018-2026",
...
Agregar(INS_SEDE_NOMBRE ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "INS_SEDE_NOMBRE",
              titulo = "Evolución total de admitidos a pregrado por sedes de admisión, periodo 2018-2026",
              labelY = "Número de admitidos<br>",
              colores = color(length(unique(AspirantesPre$INS_SEDE_NOMBRE))),
              ylim = c(0,NaN),
              libreria = c("highcharter"),
...
Agregar(SEXO ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "SEXO",
              titulo = "Evolución % total de admitidos a pregrado por género, periodo 2018-2026",
...
Agregar(ESTRATO ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "ESTRATO",
              titulo = "Evolución % total de admitidos a pregrado por estrato, periodo 2018-2026",
              labelY = "Número de admitidos",
              colores = color(length(unique(AspirantesPre$ESTRATO))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
...
Agregar(MOD_INS ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "MOD_INS",
              titulo = "Evolución % total de admitidos a pregrado por modalidad de inscripción, periodo 2018-2026",
              labelY = "Número de admitidos",
              colores = color(length(unique(AspirantesPre$MOD_INS))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
...
Agregar(TIPO_INS ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "TIPO_INS",
              titulo = "Evolución % total de admitidos a pregrado por tipología programa de inscripción, periodo 2018-2026",
              labelY = "Número de admitidos",
              colores = color(length(unique(AspirantesPre$TIPO_INS))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
...
Agregar(PAES ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "PAES",
              titulo = "Evolución % total de admitidos a pregrado Programa PAES, periodo 2018-2026",
              labelY = "Número de admitidos",
              colores = color(length(unique(Asp_PAES$PAES))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
...
Agregar(PEAMA ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "PEAMA",
              titulo = "Evolución % total de admitidos Programa PEAMA, periodo 2018-2026",
              labelY = "Número de admitidos",
              colores = color(length(unique(Asp_PEAMA$PEAMA))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
...
Agregar(TOTAL ~ YEAR + SEMESTRE,
              ...
              Plot.Series(categoria = "TOTAL",
               colores = c("#8cc63f"), # verde, Total
               titulo = "Evolución histórica total matriculados primera vez en pregrado, periodo 2018-2026",
...
Agregar(SEDE_NOMBRE_MAT ~ YEAR + SEMESTRE,
           ...
           Plot.Series(categoria = "SEDE_NOMBRE_MAT",
              titulo = "Evolución total de matriculados primera vez en pregrado por sedes, periodo 2018-2026",
              labelY = "Número de matriculados<br>",
...
Agregar(SEXO ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "SEXO",
              titulo = "Evolución % total de matriculados primera vez en pregrado por género, periodo 2018-2026",
...
Agregar(ESTRATO ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "ESTRATO",
              titulo = "Evolución % total de matriculados primera vez en pregrado por estrato, periodo 2018-2026",
              labelY = "Número de matriculados",
...
Agregar(MOD_ADM ~ YEAR + SEMESTRE,
           ...
           Plot.Series(categoria = "MOD_ADM",
              titulo = "Evolución % total de matriculados primera vez en pregrado por modalidad de admisión, periodo 2018-2026",
              labelY = "Número de matriculados",
...
Agregar(TIPO_ADM ~ YEAR + SEMESTRE,
           ...
           Plot.Series(categoria = "TIPO_ADM",
              titulo = "Evolución % total de matriculados primera vez en pregrado por tipología programas de admisión, periodo 2018-2026",
              labelY = "Número de matriculados",
...
Agregar(PAES ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "PAES",
              titulo = "Evolución % total de matriculados primera vez en pregrado Programa PAES, periodo 2018-2026",
              labelY = "Número de matriculados",
              colores = color(length(unique(Asp_PAES$PAES))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
...
Agregar(PEAMA ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "PEAMA",
              titulo = "Evolución % total de matriculados primera vez en pregrado Programa PEAMA, periodo 2018-2026",
              labelY = "Número de matriculados",
              colores = color(length(unique(Asp_PEAMA$PEAMA))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
...
Agregar(TOTAL ~ YEAR + SEMESTRE,
              ...
              Plot.Series(categoria = "TOTAL",
               colores = c("#8cc63f"), # verde, Total
               titulo = "Evolución histórica total matriculados en pregrado, periodo 2018-2026",
               labelY = "Número de matriculados<br>",
               ylim = c(0,NaN),
               libreria = c("highcharter"),
               estilo = list(hc.Tema = 5))
...
Agregar(SEDE_NOMBRE_MAT ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "SEDE_NOMBRE_MAT",
              titulo = "Evolución total de matriculados en pregrado por sedes, periodo 2018-2026",
              labelY = "Número de matriculados<br>",
...
Agregar(SEXO ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2025), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "SEXO",
              titulo = "Evolución % total de matriculados en pregrado por sexo, periodo 2018-2025",
              labelY = "Número de matriculados",
...
Agregar(ESTRATO ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "ESTRATO",
              titulo = "Evolución % total de matriculados en pregrado por estrato, periodo 2018-2026",
              labelY = "Número de matriculados",
...
Agregar(MOD_ADM ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "MOD_ADM",
              titulo = "Evolución % total de matriculados en pregrado por modalidad de admisión, periodo 2018-2026",
              labelY = "Número de matriculados",
...
Agregar(TIPO_ADM ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "TIPO_ADM",
              titulo = "Evolución % total de matriculados  en pregrado por tipología programas de admisión, periodo 2018-2026",
              labelY = "Número de matriculados",
...
Agregar(PAES ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "PAES",
              titulo = "Evolución % total de matriculados en pregrado Programa PAES, periodo 2018-2026",
              labelY = "Número de matriculados",
              colores = color(length(unique(Asp_PAES$PAES))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
...
Agregar(PEAMA ~ YEAR + SEMESTRE,
                  frecuencia = list(c(2018:2026), c(1:2)),
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "PEAMA",
              titulo = "Evolución % total de matriculados en pregrado Programa PEAMA, periodo 2018-2026",
              labelY = "Número de matriculados",
              colores = color(length(unique(Asp_PEAMA$PEAMA))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
...
Agregar(PAES ~ YEAR + SEMESTRE,
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "PAES",
              titulo = "Evolución % total de graduados en pregrado Programa PAES, periodo 2018-2026",
              labelY = "Número de graduados",
              colores = color(length(unique(Asp_PAES$PAES))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
...
Agregar(PEAMA ~ YEAR + SEMESTRE,
                    ...
                    textNA = "Sin información") %>%
           Plot.Series(categoria = "PEAMA",
              titulo = "Evolución % total de graduados en pregrado Programa PEAMA, periodo 2018-2026",
              labelY = "Número de matriculados",
              colores = color(length(unique(Asp_PEAMA$PEAMA))),
              freqRelativa = TRUE,
              ylim = c(0,NaN),
