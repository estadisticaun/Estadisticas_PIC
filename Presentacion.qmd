...
highchart() %>%
  ...
  # Opciones estéticas adicionales
  hc_title(text = "cantidad de admitidos vs cupos disponibles por programas académicos de pregrado en la Sede Medellín, Periodo 2026-2") %>%
  hc_legend(enabled = TRUE) %>%
  hc_tooltip(shared = TRUE)
...
highchart() %>%
  ...
  # Opciones estéticas adicionales
  hc_title(text = "cantidad de admitidos vs cupos disponibles por programas académicos de pregrado en la Sede Manizales, Periodo 2026-2") %>%
  hc_legend(enabled = TRUE) %>%
  hc_tooltip(shared = TRUE)
...
highchart() %>%
  ...
  # Opciones estéticas adicionales
  hc_title(text = "cantidad de admitidos vs cupos disponibles por programas académicos de pregrado en la Sede Palmira, Periodo 2026-2") %>%
  hc_legend(enabled = TRUE) %>%
  hc_tooltip(shared = TRUE)
...
highchart() %>%
  ...
  # Opciones estéticas adicionales
  hc_title(text = "cantidad de admitidos vs cupos disponibles por programas académicos de pregrado en la Sede La Paz, Periodo 2026-2") %>%
  hc_legend(enabled = TRUE) %>%
  hc_tooltip(shared = TRUE)
