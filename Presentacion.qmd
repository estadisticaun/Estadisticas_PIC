...
```
<p style="font-size: 14px;"><b>Cupos:</b> El total de cupos en programas de pregrado de la Universidad se calcula a partir de los valores definidos, por periodo académico, a través de los Consejos de Facultad.</p>
:::
